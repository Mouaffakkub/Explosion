...
landSquare.x = 300
landSquare.y = display.contentHeight - 1400
...
theGround2.x = 1520
theGround2.y = display.contentHeight - 900
...
local badCharacter = display.newImage( "./assets/sprites/Madara.png" )
badCharacter.x = 1520
...
local theCharacter = display.newImage( "./assets/sprites/Deidara.png" )
...
local function onCollision( event )
    ...
    if ( event.phase == "began" ) then
        ...
        if ( ( obj1.id == "bad character" and obj2.id == "bullet" ) or
            ...
            local expolsionSound = audio.loadStream( "./assets/sounds/sound.wav" )
			...
			local emitterParams = {
			    ...
			    startColorGreen = 9999999999999999999999999999999999999999999,
			    yCoordFlipped = -1,
			    blendFuncSource = 770,
...
function shootButton:touch( event )
    if ( event.phase == "began" ) then
        ...
        local aSingleBullet = display.newImage( "./assets/sprites/BirdBomb.png" )
